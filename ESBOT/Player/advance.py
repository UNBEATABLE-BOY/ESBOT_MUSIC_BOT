...
import sys
import heroku3
from ESBOT.main import BOT
from config import OWNER_ID, SUDO_USERS, HEROKU_APP_NAME, HEROKU_API_KEY, ALIVE_IMG as ESBOT_PIC
...
async def alive(event):
     await BOT.send_file(event.chat_id,
        ...
        [
        Button.url("• ʀᴇᴘᴏ •", "https://github.com/ITZ-ESBOT/ESBOT-Vc-Player")
        ]
        ]
        )
