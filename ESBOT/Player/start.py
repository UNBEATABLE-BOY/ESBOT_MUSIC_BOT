...
from ESBOT.main import Test, bot as Client
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data=="help":
        buttons = [
            ...
            [
                InlineKeyboardButton("🤖 Cʟᴏɴᴇʀ", url="t.me/ESBOTClonerBot"),
            ],
            [
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("🤖 Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", url="https://github.com/Itz-ESBOT/ESBOT-Vc-Player"),
            ],
            [
