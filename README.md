...
## 🅡🅔🅟🅞 🅢🅣🅐🅣🅢
![github card](https://github-readme-stats.vercel.app/api/pin/?username=ITZ-ESBOT&repo=ESBOT-Vc-Player&theme=dark)
...
- Python 3.8+ or 3.7
- [PyTgCallss](https://github.com/ITZ-ESBOT/calls)
...
- If you don't know how to get config vars : [Please refer here](https://github.com/ITZ-ESBOT/ESBOT-Vc-Player/blob/main/sample.env)
...
<p align="center"><a href="https://cloud.okteto.com/deploy?repository=https://github.com/ITZ-ESBOT/ESBOT-Vc-Player"><img src="https://img.shields.io/badge/Deploy%20To%20Okteto-informational?style=for-the-badge&logo=Okteto" width="200""/></a>

## ᴅᴇᴘʟᴏʏ ᴏɴ ʀᴀɪʟᴡᴀʏ 🚄
ꜰᴏʀ ᴅᴇᴘʟᴏʏ ᴏɴ ʀᴀɪʟᴡᴀʏ ᴍᴀᴋᴇ [Necessary Variables Here](https://github.com/ITZ-ESBOT/ESBOT-Vc-Player), ᴜ ʜᴀᴠᴇ ᴛᴏ ꜰɪʟʟ.

<p align="center"><a href="https://railway.app/new/template?template=https://github.com/ITZ-ESBOT/Music-Deploy&envs=SESSION_NAME,BOT_TOKEN,GROUP_SUPPORT,UPDATES_CHANNEL,API_ID,API_HASH,SUDO_USERS,DURATION_LIMIT"> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-black?style=for-the-badge&logo=railway" width="220" height="38.45"/></a></p>
...
```console
ESBOT@Windows~ $ git clone https://github.com/ITZ-ESBOT/ESBOT-Vc-Player
ESBOT@Windows~ $ cd ESBOT-Vc-Player
ESBOT@Windows~ $ bash setup
ESBOT@Windows~ $ cp sample.env .env
```
...
```console
ESBOT@Windows~ $ screen
ESBOT@Windows~ $ python3 main.py
```
